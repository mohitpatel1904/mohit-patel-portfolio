          ...
          >
            <div className="space-y-4">
              ...
              >
                ...
                <br />
                <span className="text-foreground/60">Extract</span>
                <br />
                <span className="text-foreground/40">Automate</span>
              </motion.h2>
              ...
              >
                Turning websites into structured data, one script at a time.
                Building automation pipelines that make data collection
                effortless.
              </motion.p>
            </div>
